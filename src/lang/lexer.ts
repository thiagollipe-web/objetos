...
export class Lexer{
 ...
 private ident(){const l=this.line,c=this.col,s=this.i;while(/[A-Za-zÀ-ÖØ-öø-ÿ0-9_]/.test(this.source[this.i]??"")){if(this.i>s&&this.source[this.i]==="x"&&/[0-9]/.test(this.source[this.i+1]??""))break;this.i++;this.col++}const x=this.source.slice(s,this.i);return{kind:"IDENT" as const,lexeme:x,literal:normalizeWord(x),line:l,column:c,endColumn:this.col}}
